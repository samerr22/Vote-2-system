...
export default function DashUsers() {
  ...
  return (
    <div>
      ...
      <img src="https://media.defense.gov/2020/Jan/24/2002238695/-1/-1/1/200124-D-RB598-002.JPG" alt="" className="w-full h-[600px] object-cover " />
    ...
    {currentUser.isAdmin ? (
      <>
        <table className="w-full divide-y divide-green-500 shadow-md">
          <thead className="bg-gradient-to-r from-[#2f3dff] to-[#e93933] via-white">
            <tr>
