...
<img src="https://media.defense.gov/2020/Jan/24/2002238695/-1/-1/1/200124-D-RB598-002.JPG" alt="" className="w-full h-[900px] object-cover " />
      ...
      <div className="bg-white bg-opacity-20 border   ml-28  w-[600px] h-96 rounded-xl">
        <div className="flex-1">
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center items-center">
            <button
              className=" bg-gradient-to-r from-[#2f3dff] to-[#e93933] via-white text-black p-3 rounded-lg w-[460px] h-11 hover:opacity-90"
              type="submit"
              disabled={loading}
            >
              {
