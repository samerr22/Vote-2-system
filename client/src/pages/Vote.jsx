...
export default function Mypoint() {
  ...
  return (
    <div className="flex">
      <img src="https://media.defense.gov/2020/Jan/24/2002238695/-1/-1/1/200124-D-RB598-002.JPG" alt="" className="w-full h-[800px] object-cover " />
        ...
        {user.map((state, index) => (
              ...
              <button
               onClick={(e) => handleSubmit(e, state._id)} 
                className="bg-gradient-to-r from-blue-700 shadow-md to-red-500 border border-white text-white w-32 h-14 rounded-xl"
              >
                Vote
              </button>
            </div>
